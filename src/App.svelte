<script>
    ...
    function onAddPageOverlay() {
      if (selectedPageIndex >= 0) {
        addingPageOverlay = true;
      }
    }
    ...
    <div
      ...
      <div
        ...
        <div
          class="flex items-center justify-center h-full w-8 hover:bg-gray-500
          cursor-pointer"
          on:click={onAddPageOverlay}
          class:cursor-not-allowed={selectedPageIndex < 0}
          class:bg-gray-500={selectedPageIndex < 0}
        >
          <img src="overlay.svg" alt="An icon for adding page overlay drawing" />
        </div>
      </div>
      ...
      <div class="w-full">
        {#each pages as page, pIndex (page)}
          <div
            ...
            on:mousedown={() => {addingPageOverlay || selectPage(pIndex)}}
            on:touchstart={() => {addingPageOverlay || selectPage(pIndex)}}>
            <div
